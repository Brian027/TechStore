...
const btnDecre = document.getElementById("decrement");
const btnIncre = document.getElementById("increment");

const myInput = document.getElementById("cartQuantity");

btnIncre.addEventListener("click", increment);
btnDecre.addEventListener("click", decrement);


function increment() {
    let idIncre = btnIncre.getAttribute("id");
    let min = myInput.getAttribute("min");
    let max = myInput.getAttribute("max");
    let step = myInput.getAttribute("step")
    let val = myInput.getAttribute("value");
    let calcStep = (idIncre == "increment") ? (step * 1) : (step * -1);
...
function decrement() {
    let idDecre = btnDecre.getAttribute("id");
    let min = myInput.getAttribute("min");
    let max = myInput.getAttribute("max");
    let step = myInput.getAttribute("step")
    let val = myInput.getAttribute("value");
    let calcStep = (idDecre == "decrement") ? (step * -1) : (step * 1);
